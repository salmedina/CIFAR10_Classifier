...
load('/Users/zal/CMU/Fall2015/10601/FinalProject/Dataset/cifar-10-batches-mat/data_batch_5.mat')
[m,n] = size(data);
hog_descriptors = extract_all_hog(data,8);
binary_labels = convert_labels(labels+1,10);
[nn_output nn_cc] = test_mlp(Model, hog_descriptors, binary_labels);
